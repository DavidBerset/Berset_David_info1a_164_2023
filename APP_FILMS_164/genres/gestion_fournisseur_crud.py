...
def genre_update_wtf():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            date_ins_genre = %(value_date_genre_essai)s WHERE id_fournisseur = %(value_id_genre)s """
            with DBconnection() as mconn_bd:
            ...
            str_sql_id_genre = "SELECT id_fournisseur FROM t_fournisseur " \
    ...
    try:
        ...
        if request.method == "GET":
            ...
            str_sql_genres_films_delete = """SELECT id_boisson_acheter_fournisseur, nom_boisson, id_fournisseur, nom_fournisseur FROM t_boisson_acheter_fournisseur 
                                            INNER JOIN t_fournisseur ON t_boisson_acheter_fournisseur.fk_boisson = t_fournisseur.id_fournisseur
